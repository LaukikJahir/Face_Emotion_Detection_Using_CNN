...
face_classifier = cv2.CascadeClassifier(r'/media/Laukik/62 GB Volume/Coding Projects/Face Emotion Detection/haarcascade_frontalface_default.xml')
try:
    classifier = load_model(r'/media/Laukik/A083-B3E6/Coding Projects/Face Emotion Detection/model.h5')
...
def process_frames():
    while True:
        ...
        faces = face_classifier.detectMultiScale(gray, scaleFactor=1.1, minNeighbors=5, minSize=(10, 10))
